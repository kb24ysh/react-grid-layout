  ...
  return (function(t) {
    ...
    function(t, e, n) {
      ...
      function m(t, e, n, r, o, a, i, s) {
        ...
        var u = e.x,
          l = e.y;
        (e.x = n), (e.y = r), (e.moved = !0);
        var c = S(t, i);
        ("vertical" === i ? l >= r : "horizontal" === i && u >= n) &&
          (c = c.reverse());
        var f = y(c, e);
        if (a && f.length)
          return (
        ...
        if (r) {
          ...
          if (!h(t, s))
            return (
              ...
              m(t, n, s.x, s.y, r, !1, o, a)
            );
        }
        return m(t, n, i ? e.x + e.w : n.x, e.y + e.h, r, !1, o, a);
      }
      function b(t) {
        return 100 * t + "%";
      }
    ...
    function(t, e, n) {
      (function(t, n) {
        ...
        function X(t) {
          return dt(t) && ft(t.length) && !!Yt[I(t)];
        }
        function F(t) {
          if (!ot(t)) return ve(t);
          var e = [];
        ...
        (Yt["[object Float32Array]"] = Yt["[object Float64Array]"] = Yt[
          ...
          (Yt[St] = Yt[_t] = Yt[Bt] = Yt[Rt] = Yt[It] = Yt[Dt] = Yt[jt] = Yt[
            Et
          ] = Yt[Ct] = Yt[zt] = Yt[kt] = Yt[Nt] = Yt[Lt] = Yt[At] = Yt[
            "[object WeakMap]"
          ] = !1);
        ...
        var Pe = ge
            ...
            : yt,
          ke = I;
        ((be && ke(new be(new ArrayBuffer(1))) != It) ||
          (we && ke(new we()) != Ct) ||
            ...
            (e.prototype.processGridItem = function(t) {
              if (t && t.key) {
                ...
                var n = this.props,
                  ...
                  x = Boolean(b && p && (e.isBounded || null == e.isBounded));
                return l.default.createElement(
                  v.default,
                  {
                    containerWidth: r,
...
*/
    ...
    function(t, e, n) {
      ...
      var s =
        ...
        m = (function(t) {
          ...
          return (
            ...
            (e.prototype.calcWidth = function(t, e) {
              return Math.round(
                e * t + Math.max(0, t - 1) * this.props.margin[0]
              );
            }),
            (e.prototype.calcHeight = function(t) {
              var e = this.props,
                n = e.rowHeight,
                r = e.margin;
              return Math.round(n * t + Math.max(0, t - 1) * r[1]);
            }),
            (e.prototype.calcPosition = function(t, e, n, r, o) {
              var a = this.props,
                ...
                c = {
                  ...
                  width: n === 1 / 0 ? n : this.calcWidth(n, l),
                  height: r === 1 / 0 ? r : this.calcHeight(r)
                };
              return (
                o &&
                  o.resizing &&
                ...
                if (s) {
                  ...
                  switch (t) {
                    ...
                    case "onDrag":
                      ...
                      var p = e.state.dragging.top + i,
                        d = e.state.dragging.left + a,
                        h = e.props,
                        y = h.isBounded,
                        g = h.w,
                        m = h.h,
                        v = h.containerWidth;
                      if (y) {
                        var b = o.offsetParent;
                        if (b) {
                          var w = b.clientHeight - e.calcHeight(m);
                          p > w && (p = w), p < 0 && (p = 0);
                          var x = v - e.calcWidth(g, e.calcColWidth());
                          d > x && (d = x), d < 0 && (d = 0);
                        }
                      }
                      (u.left = d), (u.top = p), e.setState({ dragging: u });
                      break;
                    case "onDragStop":
                      if (!e.state.dragging)
                  ...
                  var S = e.calcXY(u.top, u.left),
                    _ = S.x,
                    O = S.y;
                  return s.call(e, e.props.i, _, O, {
                    e: n,
                    node: o,
                    newPosition: u
                  });
      ...
      (m.propTypes = {
        ...
        isBounded: f.default.bool.isRequired,
          ...
          return (
            ...
            (e.prototype.onWidthChange = function(t) {
              ...
              if (
                ...
                this.props.cols !== n ||
                !(0, h.default)(t.layouts, this.props.layouts)
              ) {
