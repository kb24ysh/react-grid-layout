...
<!-- [![travis build](https://travis-ci.org/oTkPoBeHuE/otk-react-grid-layout.svg?branch=master)](https://travis-ci.org/oTkPoBeHuE/react-grid-layout) -->

<!-- [![CDNJS](https://img.shields.io/cdnjs/v/otk-react-grid-layout.svg)](https://cdnjs.com/libraries/otk-react-grid-layout) -->
